...
- `artifacts/`  
  Contains outputs generated by running `notebooks/SonarAnalysis.ipynb` and `notebooks/result-analysis.ipynb`, including extracted SonarQube issue/security-hotspot results and downstream analysis outputs (processed CSV/JSON files, plots, and summary artifacts).
